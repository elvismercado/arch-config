...
sudo pacman -Rns --noconfirm nvidia-470xx-dkms nvidia-470xx-utils lib32-nvidia-470xx-utils

yay -S --noconfirm --needed --disable-download-timeout nvidia-dkms nvidia-utils lib32-nvidia-utils
